 ...
 */
final class Version20221128064455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD parrain_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_8D93D649DE2A7A37 ON user');
        $this->addSql('ALTER TABLE user DROP parrain_id');
    }
}
